      ...
      <div className="max-w-[1440px] mx-auto px-4 lg:px-[100px]">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between pt-6 gap-4">
          ...
          <div className="flex items-center gap-3">
            <img src="./assets/icons/visa.svg" alt="Visa" className="h-8" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
            <img src="./assets/icons/mastercard.svg" alt="Mastercard" className="h-8" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
            <img src="./assets/icons/paypal.svg" alt="PayPal" className="h-8" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
            <img src="./assets/icons/applepay.svg" alt="Apple Pay" className="h-8" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
            <img src="./assets/icons/gpay.svg" alt="Google Pay" className="h-8" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
            {/* Fallback payment badges */}
            <div className="flex gap-2">
              <span className="bg-white px-2 py-1 rounded text-xs font-medium">Visa</span>
              <span className="bg-white px-2 py-1 rounded text-xs font-medium">MC</span>
              <span className="bg-white px-2 py-1 rounded text-xs font-medium">PayPal</span>
              <span className="bg-white px-2 py-1 rounded text-xs font-medium">Pay</span>
              <span className="bg-white px-2 py-1 rounded text-xs font-medium">GPay</span>
            </div>
          </div>
        </div>
      </div>
